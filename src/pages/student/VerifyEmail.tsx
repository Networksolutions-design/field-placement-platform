...
export function VerifyEmail() {
  const { firebaseUser, refreshEmailVerified } = useAuth();
  ...
  }, [verified, navigate, refreshEmailVerified]);
      ...
      <div className="max-w-md mx-auto px-4 py-16">
        <div className="bg-white rounded-xl shadow-sm p-8 text-center">
          ...
          <p className="text-sm text-gray-600 mb-6">
            ...
            . Click it, then come back here. You cannot proceed without verifying.
          </p>
          <Button
            className="w-full"
